...
namespace grace {
    ...
    public:
        VarDeclNode(std::string Id, AssignNode *Assign,
                    Type *Ty)
...
//    public:
//        ArrayDeclNode(const std::string &Id, AssignNode *Assign, ArrayType *Ty) : VarDeclNode(
...
//    };
    ...
    public:
        FuncDeclNode(std::string Name, Type *ReturnTy,
    ...
    public:
        ArrayVariableExprNode(const std::string &Id, ExprNode *IdxExpr) : Id(Id), IdxExpr(IdxExpr) {}
