...
namespace grace {
    ...
    public:
        ...
        Param(std::string Id, Type *Ty)
                : Id(std::move(Id)), Ty(Ty) {}
    };
    ...
    public:
        AssignNode(std::string Id, ExprNode *Assign) : Id(std::move(Id)), Assign(Assign) {}
    ...
    public:
        ...
        CompoundAssignNode(const std::string &id, BinOp Op, ExprNode *Assign) : AssignNode(id, Assign), Op(Op) {}
